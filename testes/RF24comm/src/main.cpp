...
void setup() {
  ...
  // Four levels are available: RF24_PA_MIN, RF24_PA_LOW, RF24_PA_HIGH and RF24_PA_MAX
  // The power levels correspond to the following output levels respectively: NRF24L01: -18dBm, -12dBm,-6dBM, and 0dBm
  radio.setPALevel(RF24_PA_MAX);

  // Data Rate
  // 0 = RF24_1MBPS for 1Mbps
  // 1 = RF24_2MBPS for 2Mbps
  // 2 = RF24_250KBPS for 250kbs
