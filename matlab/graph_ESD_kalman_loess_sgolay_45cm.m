...
%% SETTINGS
sensor = sensor2fusedESD;
sensorKAF = sensor2fusedKAFalt;
...
% SAVE
% saveas(filtering,'graphs/manuais/ESD_kalman_loess_sgolay_45cm_a','png');
...
% plot(dateRange,sensor2fusedMZScore,'DisplayName','MZ');
...
% SAVE
% saveas(filtering,'graphs/manuais/ESD_kalman_loess_sgolay_45cm_b','png');