...
% RLWOESS
rlowess01 = smooth(sensor,0.1,'rlowess'); %0.1 = span of 10% of the total number of data points
...
% SAVE
% saveas(filtering,'graphs/manuais/ESD_kalman_loess_sgolay_15cm_a','png');
...
% resultados similares ao LOESS 0.2
% plot(dateRange,wrkf,'DisplayName','ESD+WRKF','Marker','square','Visible','on');
plot(dateRange,scale_space01,'-d','DisplayName','ESD+Scale Space','MarkerIndices',1:7:length(scale_space01),'MarkerSize',10);
...
% SAVE
% saveas(filtering2,'graphs/manuais/ESD_kalman_loess_sgolay_15cm_b','png');